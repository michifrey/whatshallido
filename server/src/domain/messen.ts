...
export const messen: Messe[] = [
  ...
  {
    id: "berufsmesse-schaffhausen-2026",
    name: "Berufsmesse Schaffhausen",
    city: "Schaffhausen",
    venue: "BBZ – Berufsbildungszentrum",
    canton: "SH",
    region: "Ostschweiz",
    start: "2026-09-03",
    end: "2026-09-05",
    url: "https://berufsmesse-sh.ch/",
  },
  {
    id: "capacite-neuchatel-2026",
    name: "Capa'Cité – Salon des métiers",
    city: "Cernier (Neuchâtel)",
    venue: "Evologia",
    canton: "NE",
    region: "Romandie",
    start: "2026-09-10",
    end: "2026-09-16",
    url: "https://www.capacite.ch/",
    note: "Über 80 Berufe interaktiv erlebbar (französischsprachig).",
  },
  {
    id: "berufsmesse-thurgau-2026",
    name: "Berufsmesse Thurgau",
    city: "Weinfelden",
    venue: "Marktplatz / Rathaus Weinfelden",
    canton: "TG",
    region: "Ostschweiz",
    start: "2026-09-17",
    end: "2026-09-19",
    url: "https://berufsmesse-thurgau.ch/",
  },
  {
    id: "your-challenge-martigny-2027",
    name: "Your Challenge – Salon des métiers et formations",
    city: "Martigny",
    venue: "CERM / Martigny Expo",
    canton: "VS",
    region: "Romandie",
    start: "2027-02-16",
    end: "2027-02-21",
    url: "https://www.yourchallenge.ch/fr",
    note: "Walliser Berufsmesse mit über 400 Berufen, alle zwei Jahre (französischsprachig).",
  },
];
